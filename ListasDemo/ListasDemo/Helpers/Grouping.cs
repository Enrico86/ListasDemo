...
namespace ListasDemo.Helpers
{
    public class Grouping<K,T>:ObservableCollection<T>
        //Le estamos diciendo que esta clase tiene que ser inizializada con dos valores, un valor tipo K y
        ...
        //El parametro T representa el tipo de dato de cada uno de los elemntos de nuestra lista. La ObservableCollection
